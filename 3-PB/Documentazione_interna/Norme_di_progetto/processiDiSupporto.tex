...
\begin{itemize}
    ...
    \item \ccgloss{GitHub} per la gestione dei documenti prodotti;
...
\begin{itemize}
    ...
    \item la cartella 3-PB contenente la documentazione relativa al punto di revisione \ccgloss{Product Baseline};
