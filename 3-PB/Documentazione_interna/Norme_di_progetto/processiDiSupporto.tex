...
\begin{itemize}
    ...
    \item è un file .js, .ts, .tsx, .json e .\ccgloss{css} allora rientra nel codice e deve essere all'interno della relativa cartella (2-RTB/poc);
...
\begin{itemize}
    ...
    \item Web Stormper la verifica del codice e controllo di funzionamento.
\end{itemize}
\newpage
