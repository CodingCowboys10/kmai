...
\subsubsection{Specifica Architetturale}
La progettazione deve produrre il documento \textit{Specifica Architetturale}, il quale conterrà:
...
\begin{itemize}
    ...
    \item Una descrizione dettagliata dell'architettura, approfondendo le relazioni tra i componenti e come interagiscono;
