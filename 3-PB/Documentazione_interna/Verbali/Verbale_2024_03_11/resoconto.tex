...
\begin{enumerate}
    ...
    \item Gli obiettivi di questo sprint sono suddivisi tra il completamento della programmazione dei \ccgloss{requisiti} obbligatori dell'\ccgloss{MVP} e il progresso nella stesura dei documenti. In particolare per l'MVP, il focus sarà sulla conclusione della parte di \ccgloss{back-end} della pagina di chat.\\
    È previsto un aggiornamento generale per tutti i documenti, con l'introduzione di dettagli relativi \ccgloss{ai} test nelle Norme di Progetto. Non sono previste modifiche per il Manuale Utente, il quale sarà oggetto di lavoro durante la fase di completamento del prodotto.
...
\subsection{Azioni da intraprendere}
{
    \setlength{\tabcolsep}{10pt}
            ...
            \begin{xltabular}{\textwidth}{| l | l | l | X |}
                 ...
                 \hline
                 CC-236 & Francesco Ferraioli & 2024/03/24 & Aggiunta 9° consultivo e 10° \ccgloss{preventivo} - Piano di progetto.\\
                 \hline
...
Il 13/03/2024 si terrà la riunione ricorrente con il \ccgloss{proponente}. \\ 
