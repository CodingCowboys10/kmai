...
La riunione è stata svolta da remoto, tramite piattaforma \ccgloss{Discord}, dalle ore 10:05 alle ore 10:55.
...
\subsection{Lista partecipanti} \label{subsec:partecipanti}
{
    ...
    \begin{tabular}{| l | c |}
        ...
        \hline
        Francesco Giacomuzzo &  \textcolor{cmarkcolor}{\ding{51}}$\ast$\\
        \hline
        ...
        \hline
    \end{tabular}\\ \\
    $\ast$Il membro contrassegnato da un asterisco esce alle ore 10:40.
}