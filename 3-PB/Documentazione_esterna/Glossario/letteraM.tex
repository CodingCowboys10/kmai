...
\section{MinIO}
MinIO è un sistema di archiviazione di oggetti open source progettato per fornire uno storage scalabile, ad alte prestazioni e resiliente, che può essere utilizzato sia in locale che in \ccgloss{cloud}. Si tratta di un server di archiviazione di oggetti compatibile con l'interfaccia API di Amazon S3, che consente agli utenti di archiviare e recuperare dati in modo efficiente attraverso richieste HTTP/HTTPS.
