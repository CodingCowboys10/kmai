...
Il documento ha l'obiettivo di descrivere dettagliatamente i casi d’uso e i \ccgloss{requisiti} relativi al \ccgloss{progetto} \ccgloss{Knowledge Management} \ccgloss{AI}, ricavati dall’analisi del \ccgloss{capitolato} C1 del \ccgloss{proponente} \ccgloss{AzzurroDigitale} e dal confronto diretto con l'azienda.
\section{Glossario}
...
\begin{itemize}
    \item Slide dell’insegnamento di Ingegneria del Software, in particolare:
        \begin{itemize}
            ...
            \item Approfondimenti:\\ \url{https://github.com/rcardin/swe-imdb} \textit{(Ultimo accesso: 2024/04/02)}.
        \end{itemize}
\end{itemize}
