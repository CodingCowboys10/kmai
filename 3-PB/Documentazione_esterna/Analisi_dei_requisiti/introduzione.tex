...
\begin{itemize}
    ...
    \item Capitolato d'appalto C1: \\ \url{https://www.math.unipd.it/~tullio/IS-1/2023/Progetto/C1.pdf} \\ \textit{(Ultimo accesso: 2024/02/17)}.
...
\begin{itemize}
    \item Slide dell’insegnamento di Ingegneria del Software, in particolare:
        \begin{itemize}
            \item Analisi dei requisiti: \\ \url{https://www.math.unipd.it/~tullio/IS-1/2023/Dispense/T5.pdf}\\ \textit{(Ultimo accesso: 2024/02/17)};
            \item Diagrammi dei casi d'uso:\\ \url{https://www.math.unipd.it/~rcardin/swea/2022/Diagrammi%20Use%20Case.pdf} \textit{(Ultimo accesso: 2024/02/17)};
            \item Approfondimenti:\\ \url{https://github.com/rcardin/swe-imdb} \textit{(Ultimo accesso: 2024/02/16)}.
        \end{itemize}
\end{itemize}
