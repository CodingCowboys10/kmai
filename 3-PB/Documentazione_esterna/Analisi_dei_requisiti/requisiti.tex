...
\begin{xltabular}{\textwidth}{| c | X | c | c |}
    ...
    \hline
    RVO-5 & Dev'essere utilizzato il \ccgloss{framework} \ccgloss{Langchain} 0.0.208 o successivo per il collegamento al database vettoriale e al LLM. & Obbligatorio & Proponente, Interna \\
    \hline
    ...
    \hline
    RVO-9 & Dev'essere utilizzato Postgres per il salvataggio delle sessioni e dei messaggi scambiati tra utente e chatbot. & Obbligatorio & Interna \\
    \hline
