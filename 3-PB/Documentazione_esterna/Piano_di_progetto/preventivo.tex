...
\begin{table}[h!]
    ...
    \begin{tabularx}{\textwidth}{| l | c | c | c | c | c | c | X |}
        ...
        \hline
        %             respo-amm-pj-analis-progr-verifi
        Andrea Cecchin & - & 1 & 3 & 1 & 4 & 1 & \textbf{10} \\
        \hline
        Marco Dolzan & - & - & 4 & - & 6 & - & \textbf{10} \\
        \hline
        Francesco Ferraioli & 4 & - & - & - & 4 & - & \textbf{8} \\
        \hline  
        Francesco Giacomuzzo & - & - & 4 & - & 4 & 2 & \textbf{10} \\
        \hline
        Leonardo Lago & - & - & 1 & - & 5 & 4 & \textbf{10} \\
        \hline
        Giovanni Menon & - & - & 3 & - & 5 & 2 & \textbf{10} \\
        \hline
        Anna Nordio & - & - & 5 & - & 4 & - & \textbf{9} \\
        \hline
    \cellcolor{headerrow} \textbf{\textcolor{white}{Totale}} & \textbf{4} & \textbf{1} & \textbf{20} & \textbf{1} & \textbf{32} & \textbf{9} & \textbf{67} \\
        \hline
    \end{tabularx} 
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\textwidth]{prev10ruoli.png}
...
\begin{table}[h]
    ...
    \begin{tabularx}{\textwidth}{| l | l | l | X |}
        ...
        Analista & 25 & 1 & 25\\
        \hline
        Programmatore & 15 & 32 & 480\\
        \hline
        Verificatore & 15 & 9 & 135\\
        \hline
        \cellcolor{headerrow} \textbf{\textcolor{white}{Totale}} &  &  & \textbf{1280}\\
        \hline
        \cellcolor{headerrow} \textbf{\textcolor{white}{Rimanente}} &  &  & \textbf{2230}\\
        \hline
    \end{tabularx}
...
\begin{table}[h!]
    ...
    \begin{tabularx}{\textwidth}{| l | c | c | c | c | c | c | X |}
        ...
        \hline
        %             respo-amm-pj-analis-progr-verifi
        Andrea Cecchin & 5 & - & - & - & - & 2 & \textbf{7} \\
        \hline
        Marco Dolzan & - & 2 & - & - & 5 & 4 & \textbf{11}  \\
        \hline
        Francesco Ferraioli & - & - & - & - & 2 & 5 & \textbf{7} \\
        \hline  
        Francesco Giacomuzzo & - & 1 & - & - & 4 & 4 & \textbf{9}  \\
        \hline
        ...
        \hline
    \cellcolor{headerrow} \textbf{\textcolor{white}{Totale}} & \textbf{5} & \textbf{3} & \textbf{1} & \textbf{0} & \textbf{24} & \textbf{29} & \textbf{62} \\
        \hline
    \end{tabularx} 
...
\begin{table}[h]
    ...
    \begin{tabularx}{\textwidth}{| l | l | l | X |}
        ...
        Analista & 25 & 0 & 0\\
        \hline
        Programmatore & 15 & 24 & 360\\
        \hline
        Verificatore & 15 & 29 & 435\\
        \hline
        \cellcolor{headerrow} \textbf{\textcolor{white}{Totale}} &  &  & \textbf{1030}\\
        \hline
        \cellcolor{headerrow} \textbf{\textcolor{white}{Rimanente}} &  &  & \textbf{1015}\\
        \hline
    \end{tabularx}
