...
\\ \\
\textbf{Considerazioni a finire}\\
Questo sprint, con l'approvazione dell'MVP da parte dell'azienda proponente e la conclusione dei documenti relativi, ha determinato la fine del progetto, anche considerando la mancata partecipazione alla Customer Acceptance.\\
...
Sono state effettuate un ricco numero di riunioni, sia interne che esterne, a dimostrazione dell'importanza data al dialogo costruttivo tra compagni e soprattutto con l'azienda proponente, nella ricerca continua dei feedback con cui basare la fase di sviluppo dei prodotti.\\
