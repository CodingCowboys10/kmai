...
\begin{xltabular}{\textwidth}{| l | l | X |}
    ...
    \hline
    RO-8 & Media & I membri del gruppo che hanno dovuto svolgere un minore numero di esami, hanno aumentato il loro carico di lavoro aiutando a svolgere gli incarichi assegnati ai colleghi più impegnati, rendendo più celere la procedura e concedendo loro tempo per preparasi agli esami incombenti.\\
    \hline
