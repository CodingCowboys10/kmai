...
Il documento ha lo scopo di stabilire le metriche per assicurare la qualità del \ccgloss{progetto}, definendo linee guida da seguire per la verifica e la validazione. Verranno riportati i risultati delle misure della qualità di processi e prodotti, permettendo valutazione e accettazione di tali.
...
\begin{itemize}
    ...
    \item \ccgloss{Capitolato} d'appalto C1: \\ \url{https://www.math.unipd.it/~tullio/IS-1/2023/Progetto/C1.pdf} \textit{(Ultimo accesso: 2024/04/13)}.
\end{itemize}
