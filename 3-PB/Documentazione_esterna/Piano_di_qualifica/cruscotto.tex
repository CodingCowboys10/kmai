...
In particolare, durante il periodo \ccgloss{RTB}, vengono registrati dei valori di poco inferiori all'accettabile nel terzo e quarto sprint e un valore di poco superiore nel quinto sprint. Il motivo del numero inferiore di ore produttive è stato causato da modifiche a documenti non previsti.\\
...
Questo è causato dal mancato raggiungimento di tutti gli obiettivi fissati dalla \ccgloss{milestone} del terzo sprint.\\
...
\end{figure}
\subsection{Analisi}
Il gruppo ha codificato i test di unità e di integrazione per tutte le classi del \ccgloss{back-end} e per buona parte dei componenti del \ccgloss{front-end}. I test realizzati sono stati tutti superati dall'applicazione e attraverso gli strumenti di code coverage integrati nell'ambiente di test è stato possibile raggiungere una percentuale del 84.6\%, che rispetta i valori minimi autoimposti. 