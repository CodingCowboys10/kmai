...
Il documento ha l'obiettivo di descrivere dettagliatamente l'architettura logica e di deployment, i design \ccgloss{pattern} adottati e le tecnologie impiegate nella realizzazione del prodotto per il \ccgloss{progetto} \ccgloss{Knowledge Management} \ccgloss{AI}.
\section{Glossario}
...
\begin{itemize}
    ...
    \item \ccgloss{Capitolato} d'appalto C1: \\ \url{https://www.math.unipd.it/~tullio/IS-1/2023/Progetto/C1.pdf} \textit{(Ultimo accesso: 2024/02/10)};
...
\begin{itemize}
    ...
    \item Slide dell’insegnamento di Ingegneria del Software, in particolare:
        \begin{itemize}
            ...
            \item Il pattern \ccgloss{Dependency Injection}:\\ \url{https://www.math.unipd.it/~rcardin/swea/2022/Design%20Pattern%20Architetturali%20-%20Dependency%20Injection.pdf} \textit{(Ultimo accesso: 2024/02/10)};
    ...
    \item Sito ufficiale \ccgloss{OpenAI} \ccgloss{API}: \\
    \url{https://openai.com/blog/openai-api} \textit{(Ultimo accesso: 2024/02/20)}.
    \item Sito ufficiale \ccgloss{React}: \\
    \url{https://it.legacy.reactjs.org} \textit{(Ultimo accesso: 2024/02/20)}.
    \item Appunti su "\ccgloss{Clean} Architecture" di Robert C. Martin: \\
