...
%%TA-0 & Verificare che l’utente, all'avvio dell'applicazione, possa selezionare se  recarsi nella parte di chat; recarsi nella parte dei documenti; & UC-0, UC-0.0 & \ding{55} \\
    ...
    \end{enumerate} & UC-3.1, \newline UC-3.1.1,\newline UC-3.1.2,\newline UC-3.1.3,\newline UC-3.1.4,\newline UC-3.1.5,\newline UC-3.1.6 & \textcolor{xmarkcolor}{\ding{55}}  \\
    \hline
    ...
    \end{enumerate}& UC-4, \newline UC4.1,\newline UC4.2,\newline UC4.3 & \textcolor{xmarkcolor}{\ding{55}}  \\
    \hline
    ...
    \end{enumerate}& UC-5 & \textcolor{xmarkcolor}{\ding{55}}  \\
    \hline
    ...
    \end{enumerate}& UC-7,\newline UC-7.1,\newline UC-7.2, \newline UC-7.3 & \textcolor{xmarkcolor}{\ding{55}} \\
    \hline
    ...
    \end{enumerate}& UC-8,\newline UC-8.1,\newline UC-8.1.1,\newline UC-8.1.2,\newline UC-8.1.3 & \textcolor{xmarkcolor}{\ding{55}} \\
    \hline
    ...
    \end{enumerate}& UC-9 & \textcolor{xmarkcolor}{\ding{55}} \\
    \hline
    ...
    \end{enumerate}& UC-10,\newline UC-10.1 & \textcolor{xmarkcolor}{\ding{55}} \\
    \hline
    ...
    \end{enumerate}& UC-11,\newline UC-11.1,\newline UC-11.2 & \textcolor{xmarkcolor}{\ding{55}} \\
    \hline
    ...
    \end{enumerate}& UC-2,\newline UC-11.2,\newline UC-12 & \textcolor{xmarkcolor}{\ding{55}} \\
    \hline
    ...
    \end{enumerate}& UC-12.1,\newline UC-12.2,\newline UC-12.3 & \textcolor{xmarkcolor}{\ding{55}} \\
    \hline
    ...
    \end{enumerate}& UC-13,\newline UC-14 & \textcolor{xmarkcolor}{\ding{55}} \\
    \hline
    ...
    \end{enumerate}& UC-21,\newline UC-22,\newline UC-22.1,\newline UC-23,\newline UC-23.1 & \textcolor{xmarkcolor}{\ding{55}} \\
    \hline
    ...
    \end{enumerate}& UC-26,\newline UC-26.1,\newline UC-26.2,\newline UC-27 & \textcolor{xmarkcolor}{\ding{55}} \\
    \hline
