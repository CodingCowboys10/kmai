...
\begin{xltabular}{\textwidth}{| l | X | c | c |}
    ...
    \rowcolor{headerrow} \textbf{\textcolor{white}{Codice}} & \textbf{\textcolor{white}{Nome}} & \textbf{\textcolor{white}{Accettabile}} & \textbf{\textcolor{white}{Preferibile}} \\ 
    \endhead
    MPD-1 & Indice di Gulpease & \ge 40 & \ge 80 \\
    \hline
...
\begin{xltabular}{\textwidth}{| c | X | c | c |}
    ...
    \hline
    TS-32.2 & Verificare che l'utente possa visualizzare il numero della pagina del documento da cui deriva la risposta. & RFD-32.2 & \textcolor{xmarkcolor}{\ding{55}} \\
    \hline
    TS-32.3 & Verificare che l'utente possa visualizzare una preview del documento da cui deriva la risposta. & RFD-32.3 & \textcolor{xmarkcolor}{\ding{55}} \\
    \hline
