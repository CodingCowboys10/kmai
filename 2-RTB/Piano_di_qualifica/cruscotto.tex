...
\end{figure}
\subsection{Analisi}
Dall'analisi del grafico è immediato osservare che i valori di varianza di badget sono sempre rimasti all'interno della soglia di accettabilità.\\
È il risultato evidenziato è tuttavia migliorabile: seppur non è mai stato speso di del preventivato in uno sprint, è importante in futuro migliorare la fase di pianificazione. L'obiettivo deve essere quello di produrre preventivi sempre più vicini a quello poi consuntivato.
...
\end{figure}
\subsection{Analisi}
Dopo un ottimo inizio nei primi due sprint, è possibile notare un calo dei lavori nel terzo. L'Estimate to Complete al terzo sprint è diminuito in modo meno marcato rispetto lo sprint successivo. Inoltre, l'Estimate at Completion ha superato il Budget at Completion.\\
...
L'elevata variabilità dei valori tra un documento e l'altro certifica la difficoltà di migliorare tale metrica di qualità. Per questo motivo, è importante in futuro continuare a prestare attenzione alla struttura dei periodi delle frasi, in quanto un calo di attenzione porterebbe l'indice di un documento a non rispettare il valore di accettabilità.