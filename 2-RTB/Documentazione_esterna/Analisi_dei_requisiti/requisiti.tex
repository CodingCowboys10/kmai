...
\begin{xltabular}{\textwidth}{| c | X | c | c |}
    ...
    \hline
    RQO-5 & Deve essere fornito il manuale utente. & Obbligatorio & Interna \\
    \hline
...
\begin{xltabular}{\textwidth}{| c | X | c | c |}
    ...
    \hline
    RVO-3 & Il sistema deve permettere l'utilizzo di LLM locali tramite \ccgloss{Ollama} 0.1.19 come garanzia di sicurezza per tutti i dati contenuti nel sistema. & Obbligatorio & Proponente, Interna \\
    \hline
    RVO-4 & La web application deve essere sviluppata in \ccgloss{React} 18.2.0. & Obbligatorio & Proponente, Interna \\
    \hline
    RVO-5 & Dev'essere utilizzato il \ccgloss{framework} \ccgloss{Langchain} 0.0.208 per il collegamento al database vettoriale e al LLM. & Obbligatorio & Proponente, Interna \\
    \hline
    RVO-6 & Dev'essere utilizzato il database vettoriale \ccgloss{ChromaDB} 1.6.1 per la persistenza dei vettori \ccgloss{embedding} dei documenti. & Obbligatorio & Proponente, Interna \\
    \hline
    RVO-7 & Dev'essere utilizzato \ccgloss{Nodejs} 20.11.0 per lo sviluppo del \ccgloss{back-end}. & Obbligatorio & Proponente, Interna \\
    \hline
    RVO-8 & Dev'essere utilizzato il framework \ccgloss{Nextjs} versione 14.0.3 per lo sviluppo del back-end. & Obbligatorio & Proponente, Interna \\
    \hline
    RVO-9 & Dev'essere utilizzata la libreria \ccgloss{SQLite3} 5.1.6 per il salvataggio dei messaggi scambiati tra utente e chatbot. & Obbligatorio & Interna \\
    \hline
    RVO-10 & Dev'essere utilizzato il framework \ccgloss{Tailwind} 3.3.0 per codificare lo stile del \ccgloss{front-end}. & Obbligatorio & Interna \\
    \hline
    RVO-11 & Dev'essere utilizzato \ccgloss{MinIO} 8.4.3 per l'archiviazione dei documenti. & Obbligatorio & Proponente, Interna \\
    \hline
    RVO-12 & Dev'essere utilizzato \ccgloss{Docker} 24.0.7 per l'esecuzione del prodotto. & Obbligatorio & Interna \\
    \hline
    ...
    \hline % vincolo
    RVO-17 & Il sistema deve essere utilizzabile correttamente nel browser Google Chrome dalla versione 110 e successive. & Obbligatorio & Proponente, Interna\\  % vincolo
    \hline
...
\begin{xltabular}{\textwidth}{|X | X|}
    ...
    \makecell[l]{RFO-58,RFO-65,\\
                RFO-67,\\
                RFO-68,\\
                RFO-68,\\ RQO-1,\\ RQO-4,\\ RVO-1,\\ RVD-3,\\ RVZ-4,\\ RVZ-5,\\ RVO-6,\\ RVO-7,\\ RVO-8,\\ RVO-9,\\ RVO-10,\\ RVO-11,\\ RVO-12,\\ RVO-13,\\ RVO-16,\\ RVO-18,\\ RVO-19,\\ RVZ-20,\\ RVO-21,\\ RVO-22,\\ RVO-23,\\ RVO-24,\\ RIO-2,\\ RIO-4} & Proponente \\
    \hline
    \makecell[l]{RFD-59, \\ 
                RFO-65, \\
                RFO-67, \\
...
\begin{xltabular}{\textwidth}{| X | c | c | c |}
    ...
    \hline
    \cellcolor{headerrow} \textbf{\textcolor{white}{Totale}} & 58 & 23 & 17 \\
    \hline
