...
\begin{xltabular}{\textwidth}{| c | X | c | c |}
    ...
    \hline
    RVO-6 & Dev'essere utilizzato il database vettoriale \ccgloss{ChromaDB} 1.6.1 per la persistenza dei vettori embedding dei documenti. & Obbligatorio & Proponente, Interna \\
    \hline
