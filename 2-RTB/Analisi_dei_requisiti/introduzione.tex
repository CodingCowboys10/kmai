...
Il documento si fissa l'obiettivo di descrivere dettagliatamente i \emph{casi d’uso\ped{G}} e i \ccgloss{requisiti} relativi al \ccgloss{progetto} \ccgloss{Knowledge Management} \ccgloss{AI}, ricavati dall’analisi del \ccgloss{capitolato} C1 del \ccgloss{proponente} \ccgloss{AzzurroDigitale} e dal confronto diretto con l'azienda.
\section{Glossario}
