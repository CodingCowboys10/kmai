...
Il documento si fissa l'obiettivo di descrivere dettagliatamente i \emph{casi d’uso\ped{G}} e i \emph{requisiti\ped{G}} relativi al \emph{progetto\ped{G}} \emph{Knowledge Management\ped{G}} \emph{AI\ped{G}}, ricavati dall’analisi del \emph{capitolato\ped{G}} C1 del \emph{proponente\ped{G}} \emph{AzzurroDigitale\ped{G}} e dal confronto diretto con l'azienda.
\section{Glossario}
