...
\begin{xltabular}{\textwidth}{| c | X | c | c |}
    ...
    \hline
    RVO-11 & Dev'essere utilizzato il database vettoriale ChromaDB 1.6.1 per la persistenza dei vettori \ccgloss{embedding} dei documenti. & Obbligatorio & Proponente, Interna \\
    \hline
    RVO-12 & Dev'essere utilizzato Nodejs 20.11.0 per lo sviluppo del \ccgloss{back-end}. & Obbligatorio & Proponente, Interna \\
    \hline
    RVO-13 & Dev'essere utilizzato il framework Nextjs versione 14.0.3 per lo sviluppo del back-end. & Obbligatorio & Proponente, Interna \\
    \hline
