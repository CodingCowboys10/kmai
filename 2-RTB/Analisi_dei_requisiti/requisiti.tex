...
Per l'utilizzo di Ollama è consigliato la sua installazione ed esecuzione tramite l'immagine \ccgloss{Docker} ufficiale reperibile a \href{https://ollama.ai/blog/ollama-is-now-available-as-an-official-docker-image}{questo link}.
...
\begin{xltabular}{\textwidth}{| X | c | c | c |}
    ...
    \hline
    \cellcolor{headerrow} \textbf{\textcolor{white}{Totale}} & 49 & 22 & 16 \\
    \hline
