...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{UC3.1.1-2-3-4.PNG} %da modificare
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{UC4.1-2-3.PNG} %da modificare
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{UC7.1-2-3.PNG} %da modificare
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{UC8.1.1-2-3.PNG}%da modificare
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{UC9.PNG} %da modificare
...
\begin{description}
    ...
    \end{enumerate} 
    \item[Scenario alternativo:] Visualizza errore nell'eliminazione di un documento (\textbf{UC-9}).
\end{description}
...
\subsection{UC-9 Visualizza errore eliminazione documento}
\begin{description}
    ...
    \begin{enumerate}
        ...
        \item L'utente visualizza il singolo documento (\textbf{UC-1.1}).
        \item L'utente elimina il documento d'interesse (\textbf{UC-8}).
        \item L'utente conferma l'eliminazione del documento dal sistema (\textbf{UC-8.1}).
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{UC10-11.png} %da modificare
    \caption{Diagramma UML dei casi d'uso UC-8, UC-8.1 e UC-9}
    \label{fig:UC10-11}
\end{figure}

\subsection{UC-10 Aggiungi documento}
\begin{description}
    ...
    \begin{itemize}
        \item[] 
        \item Aggiungi documento tramite trascinamento (\textbf{UC-10.1});
        \item Aggiungi documento tramite file system (\textbf{UC-10.2}).
    \end{itemize} 
    \item[Scenario alternativo:] Visualizza errore nell'inserimento di un documento (\textbf{UC-11}).
\end{description}

\subsection{UC-10.1 Aggiungi documento tramite trascinamento}
\begin{description}
...
\subsection{UC-10.2 Aggiungi documento tramite file system}
\begin{description}
...
\subsection{UC-11 Visualizza errore inserimento documento}
\begin{description}
...
\subsection{UC-11.1 Visualizza errore nome file già presente}
\begin{description}
    ...
    \begin{enumerate}
        \item[]
        \item L’utente aggiunge un nuovo documento (\textbf{UC-10}).
        \item L'utente visualizza un messaggio d'errore (\textbf{UC-11}).
...
\subsection{UC-11.2 Visualizza errore formato file}
\begin{description}
...
\subsection{UC-11.3 Visualizza errore file corrotto}
\begin{description}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{UC12-13.PNG} %da modificare
    \caption{Diagramma UML dei casi d'uso UC-10, UC-10.1, UC-10.2, UC-11, UC-11.1, UC-11.2 e UC-11.3}
    \label{fig:UC12-13}
\end{figure}

\subsection{UC-12 Visualizza lista lingue chatbot}
\begin{description}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{UC14.png} %da modificare
    \caption{Diagramma UML del caso d'uso UC-12}
    \label{fig:UC14}
\end{figure}

\subsection{UC-13 Seleziona lingua del chatbot}
\begin{description}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{UC15.png} %da modificare
    \caption{Diagramma UML del caso d'uso UC-13}
    \label{fig:UC15}
\end{figure}

\subsection{UC-14 Inserisci domanda}
\begin{description}
...
\subsection{UC-14.1 Digita domanda}
\begin{description}
...
\subsection{UC-14.2 Input vocale della domanda}
\begin{description}
    ...
    \end{enumerate}
    \item[Scenario alternativo:] Visualizza errore nell'inserimento della domanda tramite input vocale (\textbf{UC-15}).
\end{description}

\subsection{UC-15 Visualizza errore input vocale}
\begin{description}
    ...
    \begin{enumerate}
        \item[]
        \item L’utente pone una domanda al chatbot (\textbf{UC-14}).
        \item L'utente inserisce la domanda da rivolgere al chatbot tramite input vocale (\textbf{UC-14.2}).
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{UC16-17.PNG} %da modificare
    \caption{Diagramma UML dei casi d'uso UC-14, UC-14.1, UC-14.2 e UC-15}
    \label{fig:UC16-17}
\end{figure}

\subsection{UC-16 Invia domanda}
\begin{description}
    ...
    \end{enumerate}
    \item[Scenario alternativo:] Visualizza errore invio domanda (\textbf{UC-17}).
\end{description}

\subsection{UC-17 Visualizza errore invio domanda}
\begin{description}
    ...
    \begin{enumerate}
        \item[]
        \item L’utente pone una domanda al chatbot (\textbf{UC-14}).
        \item L'utente invia la domanda al sistema (\textbf{UC-16}).
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{UC18-19.PNG} %da modificare
    \caption{Diagramma UML dei casi d'uso UC-16 e UC-17}
    \label{fig:UC18-19}
\end{figure}

\subsection{UC-18 Visualizza risposta}
\begin{description}
    ...
    \end{enumerate}
    \item[Scenario alternativo:] Visualizza un errore risposta (\textbf{UC-19}).
\end{description}

\subsection{UC-19 Visualizza errore risposta}
\begin{description}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{UC20-21.PNG} %da modificare
    \caption{Diagramma UML dei casi d'uso UC-18 e UC-19}
    \label{fig:UC20-21}
\end{figure}

\subsection{UC-20 Crea nuova sessione}
\begin{description}
    ...
    \end{enumerate}
    \item[Scenario alternativo:] Visualizza errore creazione sessione (\textbf{UC-21})
\end{description}

\subsection{UC-21 Visualizza errore creazione sessione}
\begin{description}
    ...
    \begin{enumerate}
        \item[]
        \item L'utente crea una nuova sessione di conversazione nel sistema (\textbf{UC-20}).
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{UC22-23.PNG} %da modificare
...
\begin{description}
    ...
    \end{enumerate}
    \item[Scenario alternativo:] Visualizza errore sessioni aperte (\textbf{UC-23})
\end{description}
...
\subsection{UC-23 Visualizza errore sessioni aperte }
\begin{description}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{UC24-25.PNG} %da modificare
    \caption{Diagramma UML dei casi d'uso UC-22, UC-22.1 e UC-23}
    \label{fig:UC24-25}
\end{figure}

\subsection{UC-24 Elimina sessione}
\begin{description}
...
\subsection{UC-24.1 Conferma eliminazione sessione}
\begin{description}
    \item[Descrizione:] L'utente vuole eliminare una delle sessioni di conversazioni attive nel sistema.
    \item[Attore primario:] Utente generico.
    \item[Pre condizioni:] Il sistema presenta la sessione che l'utente vuole eliminare.
    ...
    \begin{enumerate}
        ...
        \item L'utente visualizza la lista delle sessioni attive (\textbf{UC-22}).
        \item L'utente visualizza una delle sessioni attive nel sistema (\textbf{UC-22.1}).
        \item L'utente elimina dal sistema la sessione di conversazione con il chatbot desiderata (\textbf{UC-24}).
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{UC26-27.PNG} %da modificare
    \caption{Diagramma UML dei casi d'uso UC-24 e UC-24.1}
    \label{fig:UC26-27}
\end{figure}

\subsection{UC-25 Visualizza chat history}
\begin{description}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{UC28-29.PNG} %da modificare
    \caption{Diagramma UML dei casi d'uso UC-25}
    \label{fig:UC28-29}
\end{figure}

\subsection{UC-26 Elimina chat history}
\begin{description}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{UC30-31.PNG} %da modificare
    \caption{Diagramma UML dei casi d'uso UC-26}
    \label{fig:UC30-31}
\end{figure}

\subsection{UC-27 Visualizza informazioni risposta}
\begin{description}
    ...
    \begin{enumerate}
        ...
        \item L’utente pone una domanda al chatbot (\textbf{UC-14}).
        \item L'utente invia la domanda al sistema (\textbf{UC-16}).
        \item L'utente visualizza la risposta alla domanda posta al sistema (\textbf{UC-18}).
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{UC32.PNG}  %da modificare E AGGIUNGERE ATTORE SECONDARIO LLM
    \caption{Diagramma UML del caso d'uso UC-27}
    \label{fig:UC32}
\end{figure}

\subsection{UC-27.1 Visualizza nome del documento}
\begin{description}
    ...
    \begin{enumerate}
        ...
        \item L'utente invia la domanda al sistema (\textbf{UC-16}).
        \item L'utente visualizza la risposta alla domanda posta al sistema (\textbf{UC-18}).
        \item L'utente visualizza le informazioni sul documento fonte della risposta (\textbf{UC-27}).
        \item L'utente visualizza il nome del documento.
    \end{enumerate}
\end{description}

\subsection{UC-27.2 Visualizza pagina del documento}
\begin{description}
...
\subsection{UC-27.3 Visualizza preview del documento}
\begin{description}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{UC32.1-2-3.PNG} %da modificare
    \caption{Diagramma UML dei casi d'uso UC-27.1, UC-27.2 e UC-27.3}
    \label{fig:UC32.1-2-3}
\end{figure}

\subsection{UC-28 Ascolta risposta}
\begin{description}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{UC33.PNG} %da modificare
