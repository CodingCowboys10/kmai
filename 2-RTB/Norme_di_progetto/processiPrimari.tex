...
\begin{itemize}
    ...
    \item \ccgloss{Earned Value};
    \item \ccgloss{Actual Cost};
    \item \ccgloss{Planned Value};
    \item \ccgloss{Cost Variance};
    \item \ccgloss{Cost Perfromance Index};
    \item \ccgloss{Schedule Performance Index};
    \item \ccgloss{Estimate to Complete};
    \item \ccgloss{Estimate at Completion};
    \item \ccgloss{Budget at Completion}.
\end{itemize}
...
Durante il processo vengono utilizzate le seguenti metriche:
\begin{itemize}
    \item \ccgloss{Code Coverage}
    \item indice Requirements secondo \ccgloss{SEMAT};
