...
\begin{itemize}
    ...
    \item Pianificazione, con la descrizione del modello adottato dal gruppo e l'organizzazione, in \ccgloss{sprint} di due settimane, delle milestone di ogni segmento temporale con relativi obiettivi da raggiungere.
...
L'attività si articola nei seguenti compiti:
            ...
            \item Le attività sono suddivise durante le riunioni in task specifiche, composte da \ccgloss{sottotask};
...
\end{itemize}
%Nel supporto del processo di gestione delle infrastrutture tecniche, si è adottato l'uso dell'ITS Jira. Questo sistema integra strumenti di comunicazione che notificano automaticamente ciascun membro in merito alle issue assegnate, garantendo una piena consapevolezza all'interno del team. L'utilizzo di Jira all'interno del gruppo facilita la frammentazione agile dei compiti. Il responsabile crea una milestone con una scadenza di due settimane dalla sua creazione, durante la quale vengono delineate e assegnate le specifiche attività ai membri del team.%
