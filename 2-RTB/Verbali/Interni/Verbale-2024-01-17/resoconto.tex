...
\begin{enumerate}
    ...
    \item Dopo aver sostenuto il colloquio con il professor Cardin, restano da effettuare modifiche minime al documento Analisi\_dei\_\ccgloss{requisiti}, così come è necessaria una leggera modifica al documento Piano\_di\_qualifica. Tale modifica verrà riportata anche all'interno delle Norme\_di\_\ccgloss{progetto}, viene inoltre richiesta la stesura di un file README.md per quanto riguarda l'esecuzione del \ccgloss{PoC}. Si prevede di riuscire a effettuare tutte le modifiche entro la fine della settimana.
...
\subsection{Azioni da intraprendere}
{
    \setlength{\tabcolsep}{10pt}
            ...
            \begin{xltabular}{\textwidth}{| l | l | l | X |}
                 ...
                 \hline
                 CC-136 & Marco Dolzan & 2024/01/19 & Aggiunta 5° \ccgloss{consuntivo} e 6° \ccgloss{preventivo} - Piano di progetto \\
                 \hline
                 CC-139 & Andrea Cecchin & 2024/01/19 & Aggiornamento \ccgloss{use cases} - Analisi dei requisiti \\
                 \hline
